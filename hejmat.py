...
def game_intro():
    ...
    game2_lock = pygame.image.load('resources/home_left_free_lock.png')
    game2_maskot = pygame.image.load('zabky/resources/frog4.png')
    x1 = 590
    x2 = 190

    if screen_type == 1:
        game2_maskot_obj = files.intro_obj.Mascot_animation((x1 + 100, x2 + 60))
    ...
    game3_lock = pygame.image.load('resources/home_lock.png')
    game3 = pygame.transform.flip(game3, True, False)
    game3_lock = pygame.transform.flip(game3_lock, True, False)
    ...
    game3_lock_rect = game3.get_rect()
    x1 = -100
    x2 = 10
    game3_rect.topleft = (x1, x2)
    game3_lock_rect.topleft = (x1, x2)

    if screen_type == 1:
        game3_maskot_obj = files.intro_obj.Mascot_animation((x1 + 288, x2 + 50), True)
        game3_maskot_obj.max_off = 100
    elif screen_type == 2:
        game3 = pygame.transform.scale(game3, (450,258))
        game3_lock = pygame.transform.scale(game3_lock, (450, 258))
        game3_rect = game3.get_rect()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            #-----MOUTION EVENT
                ...
                if game2_rect.collidepoint(mouse_coors) and locked[0] == 1:
                ...
                if game3_rect.collidepoint(mouse_coors) and locked[1] == 1:
